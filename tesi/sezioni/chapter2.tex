...
\subsection{Modalità di accesso alla rete}
...
\begin{description}
  ...
  \item[GCM] Modalità molto simile a CTR in quanto permette tramite la derivazione sequenziale di una chiave di trasformare un cifrario a blocchi in uno a flussi. Aggiunge mediante l'uso dei campi di Galois una firma che garantisce l'integrità del processo di cifrazione.
\end{description}
